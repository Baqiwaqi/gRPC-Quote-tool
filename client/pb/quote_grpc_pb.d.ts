...
interface IQuoteToolService_IStreamQuotes extends grpc.MethodDefinition<quote_pb.QuoteService.NoParams, quote_pb.QuoteService.QuoteResponse> {
...
export interface IQuoteToolServer {
    ...
    streamQuotes: grpc.handleServerStreamingCall<quote_pb.QuoteService.NoParams, quote_pb.QuoteService.QuoteResponse>;
}
...
export interface IQuoteToolClient {
    ...
    streamQuotes(request: quote_pb.QuoteService.NoParams, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<quote_pb.QuoteService.QuoteResponse>;
    streamQuotes(request: quote_pb.QuoteService.NoParams, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<quote_pb.QuoteService.QuoteResponse>;
}
...
export class QuoteToolClient extends grpc.Client implements IQuoteToolClient {
    ...
    public streamQuotes(request: quote_pb.QuoteService.NoParams, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<quote_pb.QuoteService.QuoteResponse>;
    public streamQuotes(request: quote_pb.QuoteService.NoParams, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<quote_pb.QuoteService.QuoteResponse>;
}
