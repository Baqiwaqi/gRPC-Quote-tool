...
interface IQuoteToolService_ICreateQuote extends grpc.MethodDefinition<quote_pb.QuoteService.NoParams, quote_pb.QuoteService.QuoteResponse> {
...
export interface IQuoteToolServer {
    ...
    createQuote: grpc.handleUnaryCall<quote_pb.QuoteService.NoParams, quote_pb.QuoteService.QuoteResponse>;
...
export interface IQuoteToolClient {
    ...
    createQuote(request: quote_pb.QuoteService.NoParams, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
    createQuote(request: quote_pb.QuoteService.NoParams, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
    createQuote(request: quote_pb.QuoteService.NoParams, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
...
export class QuoteToolClient extends grpc.Client implements IQuoteToolClient {
    ...
    public createQuote(request: quote_pb.QuoteService.NoParams, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
    public createQuote(request: quote_pb.QuoteService.NoParams, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
    public createQuote(request: quote_pb.QuoteService.NoParams, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: quote_pb.QuoteService.QuoteResponse) => void): grpc.ClientUnaryCall;
