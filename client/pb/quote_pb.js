...
goog.exportSymbol('proto.quoteTool.QuoteService.QuoteListResponse', null, global);
 ...
 * @constructor
 */
proto.quoteTool.QuoteService.QuoteListResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.quoteTool.QuoteService.QuoteListResponse.repeatedFields_, null);
};
goog.inherits(proto.quoteTool.QuoteService.QuoteListResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.quoteTool.QuoteService.QuoteListResponse.displayName = 'proto.quoteTool.QuoteService.QuoteListResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {number}
 */
proto.quoteTool.QuoteService.Cargo.prototype.getLength = function() {
 ...
 * @return {!proto.quoteTool.QuoteService.Cargo} returns this
 */
proto.quoteTool.QuoteService.Cargo.prototype.setLength = function(value) {
 ...
 * @const
 */
proto.quoteTool.QuoteService.QuoteListResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.quoteTool.QuoteService.QuoteListResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.quoteTool.QuoteService.QuoteListResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.quoteTool.QuoteService.QuoteListResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.quoteTool.QuoteService.QuoteListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.quoteTool.QuoteService.QuoteListResponse}
 */
proto.quoteTool.QuoteService.QuoteListResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.quoteTool.QuoteService.QuoteListResponse;
  return proto.quoteTool.QuoteService.QuoteListResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.quoteTool.QuoteService.QuoteListResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.quoteTool.QuoteService.QuoteListResponse}
 */
proto.quoteTool.QuoteService.QuoteListResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.quoteTool.QuoteService.QuoteListResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.quoteTool.QuoteService.QuoteListResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.quoteTool.QuoteService.QuoteListResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.quoteTool.QuoteService.QuoteListResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.quoteTool.QuoteService.QuoteListResponse.prototype.getQuotesList = function() {
 ...
 * @return {!proto.quoteTool.QuoteService.QuoteListResponse} returns this
*/
proto.quoteTool.QuoteService.QuoteListResponse.prototype.setQuotesList = function(value) {
 ...
 * @return {!proto.quoteTool.QuoteService.Quote}
 */
proto.quoteTool.QuoteService.QuoteListResponse.prototype.addQuotes = function(opt_value, opt_index) {
 ...
 * @return {!proto.quoteTool.QuoteService.QuoteListResponse} returns this
 */
proto.quoteTool.QuoteService.QuoteListResponse.prototype.clearQuotesList = function() {
